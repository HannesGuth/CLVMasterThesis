...
write.csv(averages_table, paste0(getwd(), "/Results/averages_table.csv"))
write.csv(ranking_table, paste0(getwd(), "/Results/ranking_table.csv"))
write.csv(cv_table, paste0(getwd(), "/Results/cv_table.csv"))
