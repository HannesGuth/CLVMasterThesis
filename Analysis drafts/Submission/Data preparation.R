...
# Gifts
path = paste0(getwd(), "/Data/gift.csv")
gift = fread(path)
...
# Multichannel
path = paste0(getwd(), "/Data/special.csv")
multi = fread(path)
...
# Apparel
path = paste0(getwd(), "/Data/apparel.txt")
apparel = fread(path)
...
gift_list = list(data1 = gift1, data2 = gift2, l1 = 52, l2 = 52, p1 = 52, p2 = 104, BS = TRUE, name = "gift_results", wp1 = FALSE, wp2 = FALSE, smoothwidth = 2, select = 127)
el_list = list(data1 = el1, data2 = el2, l1 = 52, l2 = 52, p1 = 52, p2 = 104, BS = TRUE, name = "el_results", wp1 = FALSE, wp2 = FALSE, smoothwidth = 2, select = 520)
