...
intervals_CP_m = data.table("Id" = results.el2$Id,
                          "CET_lower" = results.el2$CET - (CET_std * quantile_CET),
                          "CET_upper" = results.el2$CET + (CET_std * quantile_CET),
                          "CET_true" = results.el2$actual.x,
                          "CET_prediction" = results.el2$CET,
                          "CET_covered" = 0,
                          "PTS_lower" = results.el2$predicted.total.spending - (PTS_std * quantile_PTS),
                          "PTS_upper" = results.el2$predicted.total.spending + (PTS_std * quantile_PTS),
