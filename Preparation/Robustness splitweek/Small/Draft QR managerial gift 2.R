...
pred = predict(est.gift2, predict.spending = TRUE, prediction.end = end2)
...
intervals_QR_m = data.table("Id" = results.gift2$Id,
...
comparison[compcounter,7] = mean(intervals_QR_m$CET_covered)
comparison[compcounter,8] = mean(intervals_QR_m$PTS_covered)
comparison[compcounter,11] = as.numeric(grid[as.numeric(index_list[1]), 2])
comparison[compcounter,12] = as.numeric(grid[as.numeric(index_list[1]), 3])
comparison[compcounter,13] = as.numeric(grid[as.numeric(index_list[1]), 4])
comparison[compcounter,14] = as.numeric(grid[as.numeric(index_list[1]), 5])
comparison[compcounter,15] = as.numeric(grid[as.numeric(index_list[2]), 2])
comparison[compcounter,16] = as.numeric(grid[as.numeric(index_list[2]), 3])
comparison[compcounter,17] = as.numeric(grid[as.numeric(index_list[2]), 4])
comparison[compcounter,18] = as.numeric(grid[as.numeric(index_list[2]), 5])
comparison[compcounter,19] = as.numeric(grid[as.numeric(index_list[1]), 2])
comparison[compcounter,20] = as.numeric(grid[as.numeric(index_list[1]), 3])
comparison[compcounter,21] = as.numeric(grid[as.numeric(index_list[1]), 4])
comparison[compcounter,22] = as.numeric(grid[as.numeric(index_list[1]), 5])
comparison[compcounter,23] = as.numeric(grid[as.numeric(index_list[2]), 2])
comparison[compcounter,24] = as.numeric(grid[as.numeric(index_list[2]), 3])
comparison[compcounter,25] = as.numeric(grid[as.numeric(index_list[2]), 4])
comparison[compcounter,26] = as.numeric(grid[as.numeric(index_list[2]), 5])